              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                  ...
                  <div className="flex flex-col items-center">
                    <h2 className="text-base font-bold text-slate-800 z-10">Fund Utilization</h2>
                    <div className="h-48 w-full relative flex items-end justify-center -mt-6">
                  ...
                  {/* AI Risk Score Donut */}
                  <div className="flex flex-col items-center">
                    <h2 className="text-base font-bold text-slate-800 z-10">AI Risk Score</h2>
                    <div className="h-48 w-full relative flex items-end justify-center -mt-6">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
