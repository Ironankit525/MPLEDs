...
export const ROLE_LANDING_PATH = {
  submitter: '/contractor/upload',
  reviewer: '/contractor/queue',
  stakeholder: '/contractor/dashboard',
  admin: '/contractor/admin/submissions',
}

export function roleLandingPath(role) {
  return ROLE_LANDING_PATH[role] || '/contractor/unsupported-role'
}
